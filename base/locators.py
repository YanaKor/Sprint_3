...
class RegistrationLocators:
    ...
    PASSWORD_FIELD = (By.XPATH, "/html/body/div/div/main/div/form/fieldset[3]/div/div/input") # Поле ввода пароля
...
class LogInFormLocators:
    ...
    LOGIN_BUTTON_FROM_REGISTER_AND_RECOVERY_PAGE = (By.XPATH, ".//main//a[contains(text(), 'Войти')]") # вход через кнопку в форме регистрации и в форме восстановления пароля
